...
class ProductPage(BasePage):
    ...
    def should_be_button(self):     # проверяем, есть ли кнопка добавления товара в корзину
        assert self.is_element_present(*BasketLocators.BASKET_BUTTON), "There is no AddToBusket button on the page or it's not found"
    ...
    def success_message_should_disappear(self): # проверяем, ушло ли сообщение на странице
        assert self.is_disappeared(*BasketLocators.SUCCESS_MESSAGE), "The success message didn't disappear, but it should have"
